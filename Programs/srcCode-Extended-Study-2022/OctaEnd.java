...
//    int row = 900;
    ...
    public static void main(String[] args) {
        OctaEnd octaEnd = new OctaEnd();
        octaEnd.writeExcel();
    }

    void writeExcel() {
        String fileName = "Y:\\2021job\\@tree\\测试OctaEnd.xlsx";
        ((ExcelWriterSheetBuilder)EasyExcel.write(fileName).sheet("OctaEnd模板").registerWriteHandler(new OctaEndRecordBorrowExcelHandler())).doWrite(this.dataList());
    }
...
class OctaEndRecordBorrowExcelHandler implements CellWriteHandler {

    OctaEndRecordBorrowExcelHandler() {
    }
