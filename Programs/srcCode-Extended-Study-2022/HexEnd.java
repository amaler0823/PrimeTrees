...
//    int row = 900;
    ...
    public static void main(String[] args) {
        HexEnd hexEnd = new HexEnd();
        hexEnd.writeExcel();
    }

    void writeExcel() {
        String fileName = "Y:\\2021job\\@tree\\测试HexEnd.xlsx";
        ((ExcelWriterSheetBuilder)EasyExcel.write(fileName).sheet("HexEnd模板").registerWriteHandler(new HexEndRecordBorrowExcelHandler())).doWrite(this.dataList());
    }
...
class HexEndRecordBorrowExcelHandler implements CellWriteHandler {

    HexEndRecordBorrowExcelHandler() {
    }
